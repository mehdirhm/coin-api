...
const SearchList: FC = (): JSX.Element => {
  ...
  const updateLocalStorage = (newResults: Coin[]) => {
    ...
    if (savedResults) {
      const previousResults: { data: Coin[]; timestamp: number }[] =
  ...
  return (
    ...
    >
      ...
      <div
        className={`${styles.header} flex flex-col justify-center items-center gap-2`}
      >
        <div>
          <span className="text-[48px]">Search Coin</span>
        </div>

        <div>
          <span>Get information from Here</span>
        </div>
      </div>
      <ul
        className="flex p-5   gap-8 flex-col mt-12 items-center justify-between text-black"
        style={{
          direction: "ltr",
        }}
      >
        ...
        <input
          ...
          className=" flex justify-center  min-w-[1470px] border bg-[#323232] text-[#ffffff] p-2 rounded"
          type="text"
          name=""
          value={searchTerm}
          id=""
            ...
            <li className="flex  flex-row items-center gap-52">
              <Link to={`/search/${coin.id}`}>
                <div className="flex flex-row gap-2 w-[200px]">
                  ...
                  <div
                    className="flex w-[80px] flex-col"
                    style={{
                      direction: "ltr",
                    }}
                  >
                    ...
                    <span
                      ...
                      className="text-[13px] text-[#ffffffff]"
                    >
                      {coin.name}
                    </span>
                  </div>
